...
![](https://image.cashwu.com/2014/fine-uploader-02/01.webp)
...
![](https://image.cashwu.com/2014/fine-uploader-02/02.webp)

`js` 如下：

![](https://image.cashwu.com/2014/fine-uploader-02/03.webp)

`controller` 如下：

![](https://image.cashwu.com/2014/fine-uploader-02/04.webp)

---

執行程式如果沒有問題的話，畫面上應該會有一個紅色的 `Button`

![](https://image.cashwu.com/2014/fine-uploader-02/05.webp)

可以 Debug 看看是不是有接到前端上傳的檔案

![](https://image.cashwu.com/2014/fine-uploader-02/06.webp)

不過如果後端什麼都不作，直接返回一個空的 `json`，這樣子前端會出錯

![](https://image.cashwu.com/2014/fine-uploader-02/07.webp)

我們可以返回一個 `success` 為 `true`，這樣子前端就會成功了

![](https://image.cashwu.com/2014/fine-uploader-02/08.webp)

---

程式如下：

![](https://image.cashwu.com/2014/fine-uploader-02/09.webp)
