...
![](https://image.cashwu.com/2024/martin-fowler-patterns-of-enterprise-application-architecture-gateway-facade-adapter-mediator/cover.webp)

## Martin Fowler 的企業級軟體架構模式

這張圖是從書上面節錄出來的，這個章節主要是在講 `Gateway` 這個 pattern，然後因為跟一些 pattern 很像，所以就列出了相關 pattern 的比較

![](https://image.cashwu.com/2024/martin-fowler-patterns-of-enterprise-application-architecture-gateway-facade-adapter-mediator/01.webp)
