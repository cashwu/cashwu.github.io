...
draft: false
images: ['https://image.cashwu.com/2024/spring-boot-spring-initializr-generate-project/cover.webp']
layout: PostSimple
---
...
![](https://image.cashwu.com/2024/spring-boot-spring-initializr-generate-project/01.webp)

在這裡可以搜尋相關的套件，按 `enter` 就可以直接加入

![](https://image.cashwu.com/2024/spring-boot-spring-initializr-generate-project/02.webp)

回到畫面上就可以看到有這個依賴

![](https://image.cashwu.com/2024/spring-boot-spring-initializr-generate-project/03.webp)

按下面的 `Explore` 就可以預覽看到，這次要產生的相關檔案

![](https://image.cashwu.com/2024/spring-boot-spring-initializr-generate-project/04.webp)

按 `Share` 的話，還可以把這次的相關資料分享給其它人

![](https://image.cashwu.com/2024/spring-boot-spring-initializr-generate-project/05.webp)
...
![](https://image.cashwu.com/2024/spring-boot-spring-initializr-generate-project/06.webp)

按下一步之後，就可以選擇相依的套件

![](https://image.cashwu.com/2024/spring-boot-spring-initializr-generate-project/07.webp)
