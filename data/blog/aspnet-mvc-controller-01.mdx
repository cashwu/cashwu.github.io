...
![](https://image.cashwu.com/2014/aspnet-mvc-controller-01/01.webp)
...
![](https://image.cashwu.com/2014/aspnet-mvc-controller-01/02.webp)

不過這樣子寫會有一些問題，如果是 `Ajax` 的時候，會返回一整個導向的頁面，
所以需要利用 `Request.IsAjaxRequest()` 作判斷，並使用原本 `base 的方法`

![](https://image.cashwu.com/2014/aspnet-mvc-controller-01/03.webp)
