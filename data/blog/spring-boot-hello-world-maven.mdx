...
images: ['/static/images/2024/spring-boot-hello-world-maven/cover.webp']
layout: PostSimple
---
...
![](/static/images/2024/spring-boot-hello-world-maven/01.webp)

2. 建立完專案，建立一個新的 `module`，這裡我們先用 `Maven`，並且使用 JDK 17

![](/static/images/2024/spring-boot-hello-world-maven/02.webp)
...
![](/static/images/2024/spring-boot-hello-world-maven/03.webp)
...
![](/static/images/2024/spring-boot-hello-world-maven/04.webp)

5. 好了之後，應該可以在 Maven 的視窗看到相關的依賴元件

![](/static/images/2024/spring-boot-hello-world-maven/05.webp)
...
![](/static/images/2024/spring-boot-hello-world-maven/06.webp)

7. 這個時候就可以使用 class 前面的執行按鈕跑起來看看，相關的 log 應該會出現在執行視窗，預設 `Tomcat` 的 port 是在 `8080`

![](/static/images/2024/spring-boot-hello-world-maven/07.webp)

8. 如果這個時間直接去瀏覽的話，應該會看到 Error 畫面，因為我們還沒有寫任何的 api/頁面，不過看到畫面就表示有正常的執行了

![](/static/images/2024/spring-boot-hello-world-maven/08.webp)

9. 如果用 api 的方式呼叫的話，應該會拿到 `404` not found

![](/static/images/2024/spring-boot-hello-world-maven/09.webp)
...
![](/static/images/2024/spring-boot-hello-world-maven/10.webp)

11. 這個時候在打一次 api，應該就可以看到我們寫的 `Hello World` 了

![](/static/images/2024/spring-boot-hello-world-maven/11.webp)
