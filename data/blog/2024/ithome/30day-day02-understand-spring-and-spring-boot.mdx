...
這個系列的範例程式碼會放在 [GitHub](https://github.com/cashwu/30day_springboot_api) 上面
...
> 同步刊登於 iTHome 鐵人賽 [「Spring Boot API 開發：從 0 到 1」Day 02 理解 Spring 和 Spring Boot](https://ithelp.ithome.com.tw/articles/10347338)
