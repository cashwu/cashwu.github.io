...
draft: true
images: ['/static/images/2024/ithome/30day-day36-spring-boot-actuator/cover.webp']
---

![](/static/images/2024/ithome/30day-day36-spring-boot-actuator/cover.webp)
...
![](/static/images/2024/ithome/30day-day36-spring-boot-actuator/01.webp)
...
![](/static/images/2024/ithome/30day-day36-spring-boot-actuator/02.webp)

### /actuator/health 應用程式健康狀況

沒有啟用 `show-details`

![](/static/images/2024/ithome/30day-day36-spring-boot-actuator/03.webp)

有啟用 `show-details`

![](/static/images/2024/ithome/30day-day36-spring-boot-actuator/04.webp)

### /actuator/info 應用程式資訊

![](/static/images/2024/ithome/30day-day36-spring-boot-actuator/05.webp)

### /actuator/metrics 應用程式指標列表

![](/static/images/2024/ithome/30day-day36-spring-boot-actuator/06.webp)

### /actuator/metrics/[name] 應用程式單一指標

查看應用程式的單一指標，這裡以 `system.cpu.count` 為例

![](/static/images/2024/ithome/30day-day36-spring-boot-actuator/07.webp)

### /actuator/env 查看環境變數

沒有啟用 `show-values`

![](/static/images/2024/ithome/30day-day36-spring-boot-actuator/08.webp)

有啟用 `show-values`

![](/static/images/2024/ithome/30day-day36-spring-boot-actuator/09.webp)
...
> 同步刊登於 iTHome 鐵人賽 [「Spring Boot API 開發：從 0 到 1」Day 36 Spring Boot Actuator 監控與管理]()
