...
![](/static/images/2024/ithome/30day-day05-spring-boot-starter/cover.webp)
...
![](/static/images/2024/ithome/30day-day05-spring-boot-Starter/01.webp)

4. 點擊你感興趣的 Starter，就可以看到它的詳細信息和使用方法，這裡以 `Spring Boot Starter` 為例，可以看到相關的詳細說明

5. 點選相關的版本 version 後，就可以看到不同的套件管理的相關寫法，

![](/static/images/2024/ithome/30day-day05-spring-boot-Starter/02.webp)

6. 點選相關的輸入框，就可以快速地直接複製內容

![](/static/images/2024/ithome/30day-day05-spring-boot-Starter/03.webp)

![](/static/images/2024/ithome/30day-day05-spring-boot-Starter/04.webp)
