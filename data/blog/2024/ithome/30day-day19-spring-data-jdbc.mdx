...
![](/static/images/2024/ithome/30day-day19-spring-data-jdbc/cover.webp)
...
總而言之，兩種方法都有其優點，選擇哪一個主要取決於你的專案需求、團隊技能和長期維護考慮

Spring Data JDBC 提供了更高層次的抽象和自動化，適合快速開發和簡單的數據模型

JdbcClient 則更靈活，適合需要精細控制 SQL 的場景。選擇取決於專案需求和複雜度
