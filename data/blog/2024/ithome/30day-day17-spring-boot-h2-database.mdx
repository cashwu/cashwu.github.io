...
draft: true
images: ['/static/images/2024/ithome/30day-day17-spring-boot-h2-database/cover.webp']
---

![](/static/images/2024/ithome/30day-day17-spring-boot-h2-database/cover.webp)
...
![](/static/images/2024/ithome/30day-day17-spring-boot-h2-database/01.webp)

![](/static/images/2024/ithome/30day-day17-spring-boot-h2-database/02.webp)
...
![](/static/images/2024/ithome/30day-day17-spring-boot-h2-database/05.webp)

為了測試方便，這裡使用了 `Embedded (Local) Database` 的方式，它會將 test DB 檔案儲存在根目錄 `~/` 下

![](/static/images/2024/ithome/30day-day17-spring-boot-h2-database/04.webp)

點連接的話，就會到預設的管理介面

![](/static/images/2024/ithome/30day-day17-spring-boot-h2-database/06.webp)
...
- 這裡只用最基本的 Java SQL 來操作 DB，可以看到需要寫非常多的程式碼，而且很麻煩
...
![](/static/images/2024/ithome/30day-day17-spring-boot-h2-database/07.webp)
...
使用這種方法，我們不需要單獨的 SQL schema，所有的資料庫初始化邏輯都集中在 Java 程式碼中，使得管理和版本控制變得更加容易。

另外，可以看到 log 裡面也有成功的訊息

![](/static/images/2024/ithome/30day-day17-spring-boot-h2-database/08.webp)
