...
![](/static/images/2024/nextjs-environment-variables-cloudflare-pages/cover.webp)
...
![](/static/images/2024/nextjs-environment-variables-cloudflare-pages/01.webp)
...
![](/static/images/2024/nextjs-environment-variables-cloudflare-pages/02.webp)

3. 加密後，畫面上就會提示你，儲存後就看不到這個變數值了，要注意

![](/static/images/2024/nextjs-environment-variables-cloudflare-pages/03.webp)

4. 儲存後，變數值就變成 `Value encrypted` 了，就算按 `編輯變數` 也看不到，只有刪除的功能

![](/static/images/2024/nextjs-environment-variables-cloudflare-pages/04.webp)

![](/static/images/2024/nextjs-environment-variables-cloudflare-pages/05.webp)

5. 可以比較一下，dashboard 新增環境變數的前後，在 `部署詳細資料` 頁面中的差異

![](/static/images/2024/nextjs-environment-variables-cloudflare-pages/06.webp)

![](/static/images/2024/nextjs-environment-variables-cloudflare-pages/07.webp)
...
![](/static/images/2024/nextjs-environment-variables-cloudflare-pages/08.webp)
