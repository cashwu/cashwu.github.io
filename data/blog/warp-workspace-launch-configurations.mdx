...
![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/cover.webp)
...
![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/01.webp)

有兩種方式可以存設定檔

你可以在選單裡面的 `File > Launch Configurations > Save New...` 存起來

![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/02.webp)

也可以用命令視窗的 `Save New Launch Configuration` 存起來

![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/03.webp)

之後會跳一個叫你輸入 `Configuration 名稱` 的視窗

上面也有提示跟你說，所有的設定檔都是存在 ` ~/.Warp/launch_configurations/` 這個路徑下面

![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/04.webp)

存好了之後也可以直接開啟剛才的 `YAML` 設定檔

![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/05.webp)

內容是長這個樣子，個人是覺得還蠻好懂的

![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/06.webp)
...
![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/07.webp)

另一個方式也是從命令視窗，`Launch Configuration Palette`，點了之後就有設定檔的 `名稱` 讓你選

![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/08.webp)

![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/09.webp)

點了之後就會開一個新的 Warp 視窗，跟我們剛才存下來的視窗是一樣的

![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/10.webp)
...
![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/11.webp)

再下一次使用設定檔時，就會一起執行命令了

![](https://image.cashwu.com/2024/warp-workspace-launch-configurations/12.webp)
