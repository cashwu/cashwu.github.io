...
前面的[文章](/blog/heroku-parse-server)已經把 Parse Server 架設在 Heroku 了，現在就來看怎麼在 js 裡面連接到 Parse Server 取得資料
...
- 可以使用之前[文章](/blog/install-parse-server-dashboard)架設的 Dashboard 來比對
