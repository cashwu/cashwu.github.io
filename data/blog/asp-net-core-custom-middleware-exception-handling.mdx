...
在之前的文章 ( [ASP.NET Core 使用內建的 ExceptionHandler Middleware 實作全站 Exception 處理](/blog/asp-net-core-exceptionhandler-middleware-handler-exception) )，使用內建的 ExceptionHandler 來處理全站的 Exception，現在要來看如何自定義 Middleware 處理全站的 Exception
