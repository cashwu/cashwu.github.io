...
![](https://image.cashwu.com/2024/monolisa-patch-icon-nerd-fonts/cover.webp)
...
![](https://image.cashwu.com/2024/monolisa-patch-icon-nerd-fonts/01.webp)

3. 使用 command line 打開專案的根目錄，執行 `ARGS="--docker -c" make patch` 命令，跑完結束會有 `Happy typing!` 的訊息

![](https://image.cashwu.com/2024/monolisa-patch-icon-nerd-fonts/02.webp)

4. 完成的字型會放在 `patched` 的資料夾內，字型的命名也會改成 `MonoLisaNerdFont-XX`

![](https://image.cashwu.com/2024/monolisa-patch-icon-nerd-fonts/03.webp)

5. 可以在不同的 command line 上面看一下前後的對照結果

`Warp` 如果沒有辦法顯示的話，就會為空

![](https://image.cashwu.com/2024/monolisa-patch-icon-nerd-fonts/04.webp)

![](https://image.cashwu.com/2024/monolisa-patch-icon-nerd-fonts/05.webp)

`Mac 內建的 Terminal` 如果沒有辦法顯示的話，就會變成 ?

![](https://image.cashwu.com/2024/monolisa-patch-icon-nerd-fonts/06.webp)

![](https://image.cashwu.com/2024/monolisa-patch-icon-nerd-fonts/07.webp)
