...
![](/static/images/2014/aspnet-mvc-db-dev-05/01.webp)

![](/static/images/2014/aspnet-mvc-db-dev-05/02.webp)

在 `Models 資料夾`下新增一個 class 叫 `客戶資料.Partial.cs`

![](/static/images/2014/aspnet-mvc-db-dev-05/03.webp)

把剛才的代碼貼上，會發現有錯誤，需要在作調整

![](/static/images/2014/aspnet-mvc-db-dev-05/04.webp)

- 1、把最上面的註解刪除
- 2、在類別名稱後面加上 `Metadata`，也就是 `客戶資料Metadata`
- 3、刪除 建構子

![](/static/images/2014/aspnet-mvc-db-dev-05/05.webp)
...
![](/static/images/2014/aspnet-mvc-db-dev-05/06.webp)
