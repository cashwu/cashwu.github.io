...
![](https://image.cashwu.com/2014/fine-uploader-01/01.webp)
...
![](https://image.cashwu.com/2014/fine-uploader-01/02.webp)

5. 下載完了之後使用 node.js 的 `command prompt` 下指令 `cd c:\fine-uploader-master` 進入 Fine Uploader 的資料夾 (在這裡的位置為 C:\fine-uploader-master)

![](https://image.cashwu.com/2014/fine-uploader-01/03.webp)

6. 下指令 `npm install` 確保所有依賴的組件都有安裝

![](https://image.cashwu.com/2014/fine-uploader-01/04.webp)

7. 跑完之後，下指令 `grunt package`，等跑出綠色的 `Done, without errors.` 字就好了

![](https://image.cashwu.com/2014/fine-uploader-01/05.webp)

![](https://image.cashwu.com/2014/fine-uploader-01/06.webp)

8. 在原本資料夾的下面會多產出一個 `_dist` 資料夾

![](https://image.cashwu.com/2014/fine-uploader-01/07.webp)
...
![](https://image.cashwu.com/2014/fine-uploader-01/08.webp)
