...
tags: [ shell, git ]
draft: false
images: ['/static/images/2024/git-sync-remote-all-branch-to-another-remote-using-shell/cover.webp']
layout: PostSimple
---

![](/static/images/2024/git-sync-remote-all-branch-to-another-remote-using-shell/cover.webp)
