---
title: 網頁實戰入門 (HTML x CSS) Class Day 02
tags:
  - html
  - css
  - course
categories: []
date: 2014-08-31 08:00:00
---
...
## Box Model
 ...
 - 如果要了解 div 的大小的話，一般會設定 background 用來測試看看是那裡跑版
  - 使用 margin時 並不會變色，因為並不是 div 的範圍
  - 使用 padding 時會變色，因為 padding算是 div 裡面的寬度
...
## 排版相關注意事項：
 ...
 - nth-child(x) 找到 html 結構裡面的 第x個元素
 - 如果是橫向排列跑版的話，9成跟 float 有關，通常是 width 或者是 overflow = hidden 的問題
