...
這是Fine Uploader的[官網](http://fineuploader.com/)

目前的版本是 4.4，Fine Uploader是一套可以跨 Browser，也可以支援不同的後端程式的上傳套件
...
這是 Fine Uploader的 [Github](https://github.com/Widen/fine-uploader)，
