---
title: GeoIP Search IP Location
tags:
  - 'c#'
categories: []
...
![](./geoip-search-ip-location/01.png)
...
![](./geoip-search-ip-location/02.png)

把前面下載的檔案 (GeoLite2-City.mmdb) 放在 Console Project 裡面

![](./geoip-search-ip-location/03.png)
...
![](./geoip-search-ip-location/04.png)
...
![](./geoip-search-ip-location/05.png)

我們可以使用 `Install-Package MaxMind.GeoIP2` 來安裝相關的 Package

4、使用 API

![](./geoip-search-ip-location/06.png)
...
![](./geoip-search-ip-location/07.png)
...
![](./geoip-search-ip-location/08.png)

在這裡我們使用幾個線上的服務來比對

- [twseo](http://dir.twseo.org/ip-check.php)

![](./geoip-search-ip-location/09.png)

- [ifreesite](http://www.ifreesite.com/ipaddress/)

![](./geoip-search-ip-location/10.png)

- [geoipview](http://cn.geoipview.com/)

![](./geoip-search-ip-location/11.png)
